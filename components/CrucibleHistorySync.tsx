...
// refreshes the server component if anything landed. The backfill cron still
// handles deep history; this is just what makes recent matches feel instant.
const THROTTLE_MS = 90_000;
const STORAGE_KEY = "crucible-recent-sync-at";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // best-effort; the backfill cron still covers history
      }
    })();
