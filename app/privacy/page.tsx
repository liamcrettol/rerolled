...
export const metadata: Metadata = {
  title: "Privacy Policy | Gun Roulette",
};

export default function PrivacyPage() {
  return (
    <main className="relative min-h-screen flex justify-center p-8">
      <div className="glass-card rounded-xl p-8 max-w-2xl w-full h-fit mt-16 text-gray-300 leading-relaxed">
        ...
        <p className="mb-4">
          Gun Roulette is a free tool for Destiny 2 fireteams. This policy explains what data
          we collect and why.
        </p>
        ...
        <p className="mb-4">
          You can revoke Gun Roulette&apos;s access at any time from your{" "}
          <a
