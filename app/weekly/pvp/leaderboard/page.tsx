...
// Full PvP weekly leaderboard for the active week (#296) - mirrors
// app/weekly/leaderboard/page.tsx, reading the "pvp" pillar and hiding the
// "Time" column (clearTimeSeconds isn't a meaningful PvP stat).
export const dynamic = "force-dynamic";

const PAGE_LIMIT = 50;

export default async function PvpWeeklyLeaderboardPage() {
  ...
  return (
    <PlatformShell displayName={session.displayName}>
      <p className="section-label mb-1">PvP Weekly Leaderboard</p>
